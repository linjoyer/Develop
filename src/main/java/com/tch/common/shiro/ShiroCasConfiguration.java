...
//
//    // cas server地址
//    public static final String casServerUrlPrefix = "http://192.168.17.201:9082/cas";
//    // Cas登录页面地址
//    public static final String casLoginUrl = casServerUrlPrefix + "/login";
//    // Cas登出页面地址
//    public static final String casLogoutUrl = casServerUrlPrefix + "/logout";
//    // 当前工程对外提供的服务地址
//    public static final String shiroServerUrlPrefix = "http://192.168.17.201:9080";
...
//    // 权限认证失败跳转地址
//    public static final String unauthorizedUrl = "/shiro_403";
//
//    //初始化ecache緩存配置
//    @Bean
...
//    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, CasFilter casFilter, UserInfoRepository userDao) {
...
//     *
//     */
//    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean, UserInfoRepository userDao){
//        /////////////////////// 下面这些规则配置最好配置到配置文件中 ///////////////////////
...
//        filterChainDefinitionMap.put("/shiro_403","anon");
//        filterChainDefinitionMap.put("/view/**","anon");
//        filterChainDefinitionMap.put("/gotologin","anon");
